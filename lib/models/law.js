...
LawSchema.options.toJSON.transform = function(doc, ret, options) {
  ...
  if (ret.nothings) ret.nothigs = ret.nothings.map(function(v) { return v.author });
  if (ret.littles) ret.nothigs = ret.littles.map(function(v) { return v.author });
  if (ret.somewhats) ret.nothigs = ret.somewhats.map(function(v) { return v.author });
  if (ret.verys) ret.nothigs = ret.verys.map(function(v) { return v.author });
}
