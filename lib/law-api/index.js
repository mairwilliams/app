...
app.get('/law/all', function (req, res) {
  ...
  api.law.all(function(err, lawDocs) {
    ...
    var keys = [
      ...
      'publishedAt deletedAt votable clauseTruncationText links author authorUrl authorPictureUrl party partyUrl backgroundColor fontColor picture'
    ].join(' ');
...
app.get('/law/:id', function (req, res) {
  ...
  api.law.get(req.params.id, function (err, lawDoc) {
    ...
    var keys = [
      ...
      'publishedAt deletedAt votable clauseTruncationText links author authorUrl authorUrl authorPictureUrl party partyUrl backgroundColor fontColor picture'
    ].join(' ');
